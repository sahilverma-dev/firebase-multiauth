...
const MadeWthLove = () => {
  return (
    <div className="fixed bg-black flex items-center group gap-1 text-sm bottom-2 right-2 bg-dark-200 text-white py-2 px-4 rounded-md ">
